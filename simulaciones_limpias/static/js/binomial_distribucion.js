...
document.getElementById('btnDescargar').addEventListener('click', () => {
    ...
    let contenido = '======== SIMULACION BINOMIAL ========\n\n';
    contenido += `Parámetros: n=${parametrosSimulacion.n}, p=${parametrosSimulacion.p}, experimentos=${parametrosSimulacion.repeticiones}\n\n`;
    
    resultadosSimulacion.forEach((exitos, index) => {
        contenido += `Experimento ${index + 1}: ${exitos} éxitos\n`;
    });
    ...
    link.download = 'resultados_binomial.txt';
